...
- Read `Packages/manifest.json` before assuming packages are present.
...
- Never: commit `Library/`, `Temp/`, build output, or secrets; regenerate or hand-edit GUIDs to "fix" conflicts; force-push shared branches; silence errors to make symptoms disappear.
