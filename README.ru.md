...
Все скриптовые установщики поддерживают `-Update`, `-Force` и `-WhatIf` с той же семантикой манифеста. Скрипты рассчитаны на Windows (PowerShell 5.1 и pwsh 7); другие платформы пока вне скоупа.
